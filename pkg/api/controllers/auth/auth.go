...
func (controller *Controller) Register(ctx *handler.Context) {
...
func (controller *Controller) Login(ctx *handler.Context) {
...
func (controller *Controller) Refresh(ctx *handler.Context) {
...
func (controller *Controller) Logout(ctx *handler.Context) {
...
func (controller *Controller) Delete(ctx *handler.Context) {
	// Authorize.
