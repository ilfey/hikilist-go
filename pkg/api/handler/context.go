...
func (ctx *Context) AuthorizedOnly() (*userModels.DetailModel, error) {
	...
	userModel, err := ctx.user.Get(ctx, map[string]any{
		"id": claims.UserID,
	})
	if err != nil {
		return nil, err
...
func (ctx *Context) GetUser() (*userModels.DetailModel, error) {
	...
	user, err := ctx.user.Get(ctx, map[string]any{
		"id": claims.UserID,
	})
	if err != nil {
		return nil, err
...
func (ctx *Context) GetClaims() (*claims.Claims, error) {
	...
	claims, err := ctx.auth.ParseToken(*token)
	if err != nil {
